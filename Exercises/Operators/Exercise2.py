...
# Use print() to display the result of the expression with integers.

penne_12pack = 16.68 * 100
pasta_24oz = 6.98  * 100
organic_clove_20 = 16.78  * 100
italian_season_bottle = 15.26  * 100
baguettes_twin_pack = 3.00  * 100
meat_balls_12oz = 4.39  * 100

rounded_sum = (penne_12pack + pasta_24oz + organic_clove_20 + italian_season_bottle + baguettes_twin_pack + meat_balls_12oz) / 100
print(rounded_sum)