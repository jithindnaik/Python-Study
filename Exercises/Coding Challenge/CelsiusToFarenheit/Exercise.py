...
cels_temp = int(input("Enter celsius temp as integer ?"))

def fahrenheit(cels_temp_int: int):
    return round(cels_temp_int * 1.8 + 32, 1)


print("The Fahrenheit equivalent of " + str(cels_temp) + " degrees Celsius is " + str((fahrenheit(cels_temp))))